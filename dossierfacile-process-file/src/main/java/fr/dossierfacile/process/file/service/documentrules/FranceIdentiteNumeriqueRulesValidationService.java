...
//    private FINApiResult fromApi(BarCodeFileAnalysis barCodeFileAnalysis) {
//        Map<String, String> dataWithLabel = (Map<String, String>) barCodeFileAnalysis.getVerifiedData();
//        return FINApiResult.builder()
//                .lastname(dataWithLabel.get(TwoDDocDataType.ID_47.getLabel()))
